...
const DiscountsTable = (props: any[]) => {
            ...
            <div className={"bg-white h-[calc(100vh-6rem)] max-h-[calc(100vh-9rem)] " +
                ...
                <table className={"w-full border-spacing-0 border-separate overflow-y-auto"}>
                    ...
                    <tr className={"rounded-tl-xl text-slate-600"}>
                        <th className={"rounded-tl-xl  bg-slate-100 py-2 border-y border-l border-stone-200"}>Nazwa zniżki</th>
                        <th className={"bg-slate-100 py-2 border-y border-stone-200"}>Procent zniżki</th>
                        <th className={"bg-slate-100 py-2 border-y border-stone-200"}>Dokument potwierdzający</th>
