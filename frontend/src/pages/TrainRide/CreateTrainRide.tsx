            ...
            <div className={"px-16 py-6 w-full"}>
                ...
                <div className={"bg-white w-full rounded-xl p-8 px-16 border border-stone-200"}>
                    ...
                    <div className={"h-6 flex w-full text-red-900 text-xs"}>
                        ...
                        // @ts-ignore
                        (createTrainRideError!.data === "Dana linia przejazdu i pociąg nie istnieje" || createTrainRideError!.data === "Dana linia przejazdu nie istnieje") ?
                            "visible w-full" : "invisible absolute"}`}>
                            <ExclamationMark className={"h-5 mr-2"}/>
                            <p className={"w-full"}>
                    ...
                    <div className={"h-6 flex w-full text-red-900 text-xs"}>
                        ...
                        <div className={`flex items-center ${isCreateTrainRideError &&
                        // @ts-ignore
                        (createTrainRideError!.data === "Dana linia przejazdu i pociąg nie istnieje" || createTrainRideError!.data === "Dany pociąg nie istnieje") ?
                            "visible w-full" : "invisible absolute"}`}>
                            <ExclamationMark className={"h-5 mr-2"}/>
                            <p className={"w-full"}>
